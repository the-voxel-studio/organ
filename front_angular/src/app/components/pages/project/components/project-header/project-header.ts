...
@Component({
  ...
  template: `
    <header class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-12">
      ...
      <div class="flex items-center gap-3">
        @if (canManage) {
          <a [routerLink]="['/project', project.uuid, 'trash']" class="p-3 bg-white border border-gray-200 text-gray-400 hover:text-red-500 hover:border-red-100 hover:bg-red-50 rounded-2xl transition-all active:scale-95 shadow-sm group cursor-pointer">

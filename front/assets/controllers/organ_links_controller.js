...
export default class extends Controller {
    static targets = ['panel', 'list', 'urlInput', 'descriptionInput', 'form', 'submitBtn', 'spinner'];
    static values = {
        projectUuid: String,
        organUuid: String,
        canManage: Boolean
    ...
    async delete(event) {
        ...
        try {
            const response = await fetch(`/api/projects/${this.projectUuidValue}/organs/${this.organUuidValue}/links/${linkUuid}`, {
                method: 'DELETE',
                credentials: 'include'
            });
